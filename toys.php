            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 produts-sidebar-filter">
                    <div class="filter-widget">
						...
						<?php
							$Product = $db->select("distinct Categories","toys_product");
					...
					<div class="filter-widget">
                        ...
                        <ul class="filter-catagories">
						<?php
							$Product = $db->select("distinct SubCategory","toys_product");
							for ($i=0; $i < count($Product); $i++) { 
								echo 
                    ...
                    <div class="filter-widget">
                        ...
                        <div class="fw-brand-check">
							<?php
								$Product = $db->select("distinct Brand","toys_product");
								for ($i=0; $i < count($Product); $i++) { 
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                    <div class="product-show-option">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-5 text-right">
                                <p>Show 01- 09 Of 
								<?php
									$Product = $db->select("*","toys_product");
									echo count($Product);
								?>
								Product</p>
                            </div>
                    ...
                    <div class="product-list">
                        <div class="row">
							<?php
								$Product = $db->select("id, Categories, Title, Price, image","toys_product");
								for ($i=0; $i < count($Product); $i++) { 
							?>
                                ...
                                <div class="product-item">
                                    <div class="pi-pic">
                                        ...
                                        <ul>
                                            ...
                                            <li class="quick-view"><button class='add_shopping_cart' id="item_<?php echo $Product[$i]['id'] ?>" product_price="<?php echo $Product[$i]['Price'] ?>" product_name="<?php echo $Product[$i]['Title'] ?>">Add to Cart</button></li>
