                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="place-order">
                            ...
                            <div class="order-total">
                                <ul class="order-table" id='order-table-list'>
									<?php
										// $product_array = $db_handle->runQuery("SELECT * FROM tblproduct ORDER BY id ASC");
									?>
                                    <li>Product <span>Price</span></li>
                                    <!-- <li class="fw-normal"><?php echo $product_array[0]["name"]; ?><span><?php echo "$".$product_array[0]["price"]; ?></span></li> -->
                                ...
                                <div class="payment-check">
                                    <div class="pc-item">
                                        <label for="pc-check">
                                            Cheque Payment
                                            <input type="radio" id="pc-check" name='payment_method' value='check'>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="pc-item">
                                        <label for="pc-paypal">
                                            Paypal
                                            <input type="radio" id="pc-paypal" name='payment_method' value='paypal'>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
									<div class="pc-item">
                                        <label for="pc-stripe">
                                            Stripe
                                            <input type="radio" id="pc-stripe" name='payment_method' value='stripe' checked>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
									<div class="pc-item">
                                        <label for="pc-payme">
                                            Payme
                                            <input type="radio" id="pc-payme" name='payment_method' value='payme'>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="order-btn">
                                    <button type='button' class="site-btn place-btn" id='place_order'>Place Order</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    $(function () {
        ...
        for(i in shopping_cart){
            ...
            $('#order-table-list').append(`
                <li class="fw-normal">${shopping_cart[i]['name']} x ${shopping_cart[i]['num']} <span>$${shopping_cart[i]['price']*shopping_cart[i]['num']}</span></li>
            `);
        }
        $('#icon_bag_alt_num').text(icon_bag_alt_num);
        t_price = total_price(shopping_cart);
        $('#order-table-list').append(`<li class="total-price">Total <span>$${t_price}</span></li>`);
    });
